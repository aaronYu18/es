...
public class EsSearchServiceImpl implements EsSearchService, Serializable {
    private List<String> clusterList = null;
    private Logger logger = Logger.getLogger(EsSearchServiceImpl.class);
